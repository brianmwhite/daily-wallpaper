...
Defines how the auto-update fetch/apply body is exposed as a hidden explicit subcommand, and how launchd plists created by older versions (without that subcommand) are detected and migrated automatically on their next scheduled run.
